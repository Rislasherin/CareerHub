...
exports.GetHRCandidatesUseCase = void 0;
const infra_container_1 = require("@infrastructure/di/infra.container");
class GetHRCandidatesUseCase {
    constructor(_jobRepository, _studentRepository) {
            ...
            if (bestJob && highestScore >= 0) {
                ...
                if (student.collegeId) {
                    if (collegeCache.has(student.collegeId)) {
                        ...
                        try {
                            const college = await infra_container_1.organizationRepository.findById(student.collegeId);
                            if (college) {
...
exports.GetHRCandidatesUseCase = GetHRCandidatesUseCase;
