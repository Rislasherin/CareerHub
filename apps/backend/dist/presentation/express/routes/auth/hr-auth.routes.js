...
router.post(route_constants_1.API_ROUTES.AUTH.HR_LOGIN, (0, shared_auth_helpers_1.assignRole)(role_enum_1.Role.HR), (0, validate_dto_middleware_1.validateDto)(login_request_dto_1.LoginRequestDto), container_1.container.hrAuthController.login);
