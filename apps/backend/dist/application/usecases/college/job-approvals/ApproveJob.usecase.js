...
exports.ApproveJobUseCase = void 0;
    ...
    async execute(collegeId, jobId) {
        ...
        if (job.collegeId === "ALL") {
            if (job.approvedColleges.includes(collegeId)) {
                throw new AppError_1.AppError("Job already approved by your college", HttpStatus_enum_1.HttpStatus.BAD_REQUEST, ErrorCodes_enum_1.ErrorCode.VALIDATION_ERROR);
            }
            ...
            job.status = JobStatus_enum_1.JobStatus.APPROVED;
            job.approveForCollege(collegeId);
        }
        return await this._jobRepository.update(jobId, job);
    }
}
exports.ApproveJobUseCase = ApproveJobUseCase;
