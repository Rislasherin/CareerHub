                ...
                <div className="flex-1 overflow-y-auto p-6 md:p-10 bg-slate-100/50">
                  <div id="offer-letter-preview" className="bg-white p-8 md:p-12 border border-slate-200 shadow-lg rounded-xl max-w-3xl mx-auto text-slate-800">
                    <div className="text-center mb-10">
                      <h2 className="text-3xl font-black text-slate-900">{selectedOffer.job?.companyId?.name || selectedOffer.company?.name || 'Company Name'}</h2>
                    ...
                    <div className="space-y-6 text-sm leading-relaxed">
                      ...
                      <p>
                        We are pleased to extend an offer of employment for the position of <strong className="text-slate-900">{selectedOffer.role || '[Role]'}</strong> at {selectedOffer.job?.companyId?.name || selectedOffer.company?.name || 'Company Name'}. 
                      ...
                      <div className="flex justify-between mt-16 pt-8 border-t border-slate-200">
                        <div className="text-xs text-slate-500 font-medium">
                          HR Manager • {selectedOffer.job?.companyId?.name || selectedOffer.company?.name || 'Company Name'}
                        </div>
