...
exports.makeCollegeAdminAuthController = exports.makeVerifyCollegeOtpUseCase = exports.makeRegisterOrganizationUseCase = exports.makeLoginCollegeAdminUseCase = void 0;
...
const makeLoginCollegeAdminUseCase = () => {
    return new LoginCollegeAdmin_usecase_1.LoginCollegeAdminUseCase(infra_container_1.collegeAdminRepository, infra_container_1.jwtService, infra_container_1.bcryptService);
};
exports.makeLoginCollegeAdminUseCase = makeLoginCollegeAdminUseCase;
const makeRegisterOrganizationUseCase = () => {
    return new register_organization_usecase_1.RegisterOrganizationUseCase(infra_container_1.collegeAdminRepository, infra_container_1.organizationRepository, infra_container_1.bcryptService, infra_container_1.jwtService, infra_container_1.otpRepository, new email_service_1.EmailService());
};
...
const makeCollegeAdminAuthController = () => {
    return new college_admin_auth_controller_1.CollegeAdminAuthController((0, exports.makeRegisterOrganizationUseCase)(), (0, exports.makeVerifyCollegeOtpUseCase)(), (0, exports.makeLoginCollegeAdminUseCase)());
};
