...
exports.toComptypePersistence = exports.toComptypeEntity = void 0;
const Comptype_1 = require("@domain/entities/Comptype");
const toComptypeEntity = (doc) => {
    return Comptype_1.Comptype.create({
        id: doc._id.toString(),
        name: doc.name,
...
exports.toComptypeEntity = toComptypeEntity;
const toComptypePersistence = (entity) => {
...
exports.toComptypePersistence = toComptypePersistence;
